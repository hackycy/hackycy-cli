...
func (_q *AccountQuery) QueryClients() *ServerClientQuery {
...
func (_q *AccountQuery) WithClients(opts ...func(*ServerClientQuery)) *AccountQuery {
	query := (&ServerClientClient{config: _q.config}).Query()
...
func (_q *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := _q.withClients; query != nil {
		if err := _q.loadClients(ctx, query, nodes,
			func(n *Account) { n.Edges.Clients = []*ServerClient{} },
			func(n *Account, e *ServerClient) { n.Edges.Clients = append(n.Edges.Clients, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AccountQuery) loadClients(ctx context.Context, query *ServerClientQuery, nodes []*Account, init func(*Account), assign func(*Account, *ServerClient)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(serverclient.FieldOwnerAccountID)
	}
	query.Where(predicate.ServerClient(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(account.ClientsColumn), fks...))
	}))
