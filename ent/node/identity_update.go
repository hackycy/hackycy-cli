...
func (_u *IdentityUpdate) SetNodeID(v string) *IdentityUpdate {
	_u.mutation.SetNodeID(v)
	return _u
}

// SetNillableNodeID sets the "node_id" field if the given value is not nil.
func (_u *IdentityUpdate) SetNillableNodeID(v *string) *IdentityUpdate {
	if v != nil {
		_u.SetNodeID(*v)
	}
	return _u
...
func (_u *IdentityUpdate) SetPrivateKey(v []byte) *IdentityUpdate {
	_u.mutation.SetPrivateKey(v)
	return _u
}

// SetPublicKey sets the "public_key" field.
func (_u *IdentityUpdate) SetPublicKey(v []byte) *IdentityUpdate {
...
// SetNodeID sets the "node_id" field.
func (_u *IdentityUpdateOne) SetNodeID(v string) *IdentityUpdateOne {
	_u.mutation.SetNodeID(v)
	return _u
}

// SetNillableNodeID sets the "node_id" field if the given value is not nil.
func (_u *IdentityUpdateOne) SetNillableNodeID(v *string) *IdentityUpdateOne {
	if v != nil {
		_u.SetNodeID(*v)
	}
	return _u
...
// SetPrivateKey sets the "private_key" field.
func (_u *IdentityUpdateOne) SetPrivateKey(v []byte) *IdentityUpdateOne {
	_u.mutation.SetPrivateKey(v)
	return _u
}

// SetPublicKey sets the "public_key" field.
func (_u *IdentityUpdateOne) SetPublicKey(v []byte) *IdentityUpdateOne {
	_u.mutation.SetPublicKey(v)
	return _u
}
...
func (_u *IdentityUpdateOne) sqlSave(ctx context.Context) (_node *Identity, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`node: missing "Identity.id" for update`)}
	}
