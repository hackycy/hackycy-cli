...
var approvedPackageInventory = []string{
	...
	"ent/server/migrate",
	"ent/server/node",
	"ent/server/nodemanagementcandidate",
	"ent/server/nodeobservation",
	"ent/server/nodeportpool",
	"ent/server/predicate",
	"ent/server/remotenode",
	"ent/server/runtime",
	"ent/server/schema",
	"ent/server/serverclient",
	"ent/server/tunnel",
	"ent/server/tunnelhttproute",
	"internal/appconfig",
	...
	"pkg/cmd/config/tunnel",
	"pkg/cmd/config/tunnel/list",
	"pkg/cmd/config/tunnel/remove",
	"pkg/cmd/diff",
	"pkg/cmd/export",
	"pkg/cmd/export/env",
	"pkg/cmd/factory",
