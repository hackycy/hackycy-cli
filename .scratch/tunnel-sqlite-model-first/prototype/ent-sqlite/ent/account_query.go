...
func (_q *AccountQuery) QueryAllocations() *AllocationQuery {
...
func (_q *AccountQuery) WithAllocations(opts ...func(*AllocationQuery)) *AccountQuery {
	query := (&AllocationClient{config: _q.config}).Query()
...
func (_q *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := _q.withAllocations; query != nil {
		if err := _q.loadAllocations(ctx, query, nodes,
			func(n *Account) { n.Edges.Allocations = []*Allocation{} },
			func(n *Account, e *Allocation) { n.Edges.Allocations = append(n.Edges.Allocations, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AccountQuery) loadAllocations(ctx context.Context, query *AllocationQuery, nodes []*Account, init func(*Account), assign func(*Account, *Allocation)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(allocation.FieldOwnerID)
	}
	query.Where(predicate.Allocation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(account.AllocationsColumn), fks...))
	}))
