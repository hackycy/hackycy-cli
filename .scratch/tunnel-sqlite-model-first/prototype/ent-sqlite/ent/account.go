...
func (e AccountEdges) AllocationsOrErr() ([]*Allocation, error) {
	if e.loadedTypes[0] {
...
// QueryAllocations queries the "allocations" edge of the Account entity.
func (_m *Account) QueryAllocations() *AllocationQuery {
	return NewAccountClient(_m.config).QueryAllocations(_m)
}
